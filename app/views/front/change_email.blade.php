            ...
            <div class="container">
                ...
                <div class="col-md-9 store_profile_area">
                    <div class="store_profile">
                        ...
                        <form method="post" class="shop_profile_form form-horizontal" action="{{URL::to('change_email_action/'.$store_id)}}">                            
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend">                                        
                                        <input type="email" placeholder="Current Email" name="current_email" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend">                                        
                                        <input type="email" placeholder="New Email" name="new_email" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="controls">
                                <button class="btn btn-primary" id="mybtn" type="submit">Change Email</button>
                            </div>
                            <div class="clear"></div>
                        </form>
                    </div>
