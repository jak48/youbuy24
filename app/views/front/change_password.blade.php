            ...
            <div class="container">
                ...
                <div class="col-md-9 store_profile_area">
                    <div class="store_profile">
                        ...
                        <form method="post" class="shop_profile_form form-horizontal" action="{{URL::to('change_password_action/'.$store_id)}}">                            
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend">                                        
                                        <input type="password" placeholder="New Password" name="new_password" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend">                                        
                                        <input type="password" placeholder="Current Password" name="confirm_password" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend">                                        
                                        <input type="password" placeholder="Current Password" name="current_password" class="input-xlarge">
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
                            ...
                            <div class="controls">
                                <button class="btn btn-primary" id="mybtn" type="submit">Change Password</button>
                            </div>
                            <div class="clear"></div>
                        </form>
                    </div>
